...
>
> We may not always be able to provide prompt support for this plugin on the WordPress.org forums. If you would like to have professional support or extra/custom features, consider buying the [Ultra version](http://buy.thulasidas.com/google-adsense "Pro version of the Ads EZ Plugin for Google AdSense plugin for $9.45")
...
Ads EZ Plugin for Google AdSense is the freely distributed version of a premium plugin. The [Ultra version](http://buy.thulasidas.com/google-adsense "Pro version of the Ads EZ Plugin for Google AdSense plugin for $9.45") gives you even more features.
...
1. Ads EZ Plugin for Google AdSense "Overview" tab.
2. How to set the options for Ads EZ Plugin for Google AdSense.
...
* V4.20: Compatibility with WP4.8. Sunset edition. [Aug 1, 2017]
