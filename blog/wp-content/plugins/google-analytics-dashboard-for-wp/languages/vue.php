...
$generated_i18n_strings = array(
	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:129
	__( '1', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:130
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:37
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportForms-Lite.vue:36
	__( 'Unlock the Forms Report and Improve Conversions', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportForms-Lite.vue:37
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:36
	...
	// Reference: src/modules/settings/exactmetrics-site.vue:86
	__( 'You\'re now using ExactMetrics Pro with all the features.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/exactmetrics-site.vue:88
	/* Translators: Placeholder gets replaced with an arrow icon. */
	...
	// Reference: src/modules/addons/exactmetrics-addons-Lite.vue:67
	__( 'Refresh Addons', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/addons/exactmetrics-addons-Lite.vue:68
	__( 'ExactMetrics Addons', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/addons/exactmetrics-addons-Lite.vue:70
	/* Translators: Adds a line break. */
	__( 'Upgrade to Pro to unlock addons and other great features.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/addons/exactmetrics-addons-Lite.vue:71
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:121
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:127
	__( 'Guide and Checklist for Advanced Insights', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:128
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:133
	__( 'GDPR Guide', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:134
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:139
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:145
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabGettingStarted.vue:150
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:106
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:135
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:143
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:159
	__( 'Get weekly traffic reports directly in your inbox.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:165
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:169
	__( 'Order Popular Posts by comments or shares with 3 simple theme choices.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:170
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:180
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:184
	__( 'Support', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:187
	__( 'Limited Support', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:188
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:85
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:87
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:95
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:96
	__( 'Advanced Tracking Options', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:97
	...
	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:115
	__( 'Inbox', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:116
	__( 'Back to Inbox', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:117
	__( 'View Dismissed', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:118
	__( 'Notifications', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:119
	__( 'Dismiss All', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:120
	__( 'Dismissed', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/notifications/components/exactmetrics-Notifications.vue:121
	...
	// Reference: src/modules/wizard-onboarding/components/steps/MigrationStepUpsell.vue:41
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportRealTime-Lite.vue:35
	__( 'Real-Time Report', 'google-analytics-dashboard-for-wp' ),
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportRealTime-Lite.vue:50
	__( 'See Your Top Pages Immediately After Making Changes', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportRealTime-Lite.vue:54
	__( 'See Your Top Referral Sources and Adapt Faster', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportRealTime-Lite.vue:58
	__( 'See Your Traffic Demographics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportRealTime-Lite.vue:62
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportForms-Lite.vue:48
	__( 'See Your Top Converting Forms and Optimize', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportForms-Lite.vue:52
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:151
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:198
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:37
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:48
	__( 'Post Type tracking to see which WordPress post types perform better', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:52
	__( 'Category tracking to see which sections of your sites are the most popular', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:56
	__( 'SEO score tracking to see which blog SEO scores are the most popular', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:60
	__( 'Focus Keyword tracking to see which of your content is doing well in search engines.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportDimensions-Lite.vue:64
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:39
	/* Translators: add link to blog. */
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:46
	__( 'See Your Homepage\'s Overall Performance Score', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:50
	__( 'Run an Audit on Your Homepage and See Your Server Response Time', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:54
	__( 'Learn How Long It Takes for Your Viewers to Interact With Your Site', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-SiteSpeed-Lite.vue:58
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:326
	__( 'Gender', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:327
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:341
	__( 'So, where did all of these visitors come from?', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:342
	__( 'Clicks', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:343
	__( 'Your Top 5 Keywords', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:344
	__( 'What keywords visitors searched for to find your site', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:345
	__( 'Your Top 5 Referrals', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:347
	__( 'The websites that link back to your website', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:348
	__( 'Opportunity', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:349
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:350
	__( 'Read - 5 Ways to Skyrocket Your SEO Rankings with Google Analytics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:352
	__( 'Thank you for using ExactMetrics!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-YearInReview-Lite.vue:353
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:243
	__( 'Your site is connected to ExactMetrics!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:265
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:88
	__( 'Connect ExactMetrics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:89
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:91
	...
	// Reference: src/modules/frontend/components/exactmetrics-FrontendStatsGeneral.vue:59
	...
	// Reference: src/modules/frontend/components/exactmetrics-FrontendStatsGeneral.vue:63
	__( 'Avg. Duration', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/frontend/components/exactmetrics-FrontendStatsGeneral.vue:74
	__( 'More data is available', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/frontend/components/exactmetrics-FrontendStatsGeneral.vue:76
	...
	// Reference: src/modules/addons/components/exactmetrics-AddonBlock.vue:115
	__( 'Network Active', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/addons/components/exactmetrics-AddonBlock.vue:115
	__( 'Active', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/addons/components/exactmetrics-AddonBlock.vue:117
	...
	// Reference: src/modules/wizard-onboarding/components/inputs/exactmetrics-OnboardingLicense-Lite.vue:34
	...
	// Reference: src/modules/wizard-onboarding/components/inputs/exactmetrics-OnboardingLicense-Lite.vue:35
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabConversions-Lite.vue:59
	__( 'See who\'s viewing and submitting your forms, so you can increase your conversion rate.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabConversions-Lite.vue:61
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:104
	__( 'Settings successfully updated!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:111
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:65
	__( 'Use the button below to export a file with your ExactMetrics settings.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:66
	__( 'Choose file', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:73
	__( 'No file chosen', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:88
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabAdvanced.vue:109
	/* Translators: placeholders make text small. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabAdvanced.vue:121
	/* Translators: placeholders make text small. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabAdvanced.vue:126
	/* Translators: placeholders make text small. */
	__( 'Minor only %1$s- Get bugfixes and security updates, but not major features.%2$s', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabAdvanced.vue:131
	/* Translators: placeholders make text small. */
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:116
	__( 'Make your ExactMetrics campaign links prettier with Pretty Links!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:117
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:118
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:119
	__( 'Over 200,000 websites use Pretty Links!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:120
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:124
	__( 'Activate Pretty Links', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:125
	__( 'Activating Pretty Links...', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:126
	__( 'Create New Pretty Link', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:127
	__( 'Create a New Pretty Link', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsPrettyLinksFlow.vue:128
	__( 'Grab your campaign link and paste it into the Target URL field.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:175
	__( 'Custom Campaign Parameters', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:176
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:183
	/* Translators: Marks the field as required. */
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:195
	__( 'Enter something to differentiate ads', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:196
	__( 'Use Fragment', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:198
	/* Translators: Make the text bold. */
	__( 'Set the parameters in the fragment portion of the URL %1$s(not recommended)%2$s', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:199
	__( 'URL to use', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:200
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:215
	__( 'Campaign Source', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:216
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:218
	__( 'Use utm_medium to identify a medium such as email or cost-per-click.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:219
	__( 'Campaign Name', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:220
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:222
	__( 'Used for paid search. Use utm_term to note the keywords for this ad.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:223
	__( 'Campaign Content', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:224
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:226
	/* Translators: Example. */
	__( 'Example: %s', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:228
	/* Translators: Examples. */
	__( 'Examples: %s', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:231
	__( 'About Campaigns', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:235
	__( 'About Custom Campaigns', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:239
	__( 'Best Practices for Creating Custom Campaigns', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:243
	__( 'About the Referral Traffic Report', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:247
	__( 'About Traffic Source Dimensions', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:251
	__( 'AdWords Auto-Tagging', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/exactmetrics-ToolsTabUrlBuilder.vue:255
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabPublisher.vue:76
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabPublisher.vue:77
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabPublisher.vue:80
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabPublisher.vue:81
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEcommerce-Lite.vue:57
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEcommerce-Lite.vue:98
	__( 'Works with WooCommerce, MemberPress, and EasyDigitalDownloads.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:123
	__( 'Cross Domain Tracking', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:125
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:88
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:91
	__( 'Enable Anchor Tracking', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:92
	__( 'Enable allowAnchor', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:93
	__( 'Enable allowLinker', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:94
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:96
	__( 'Extensions of Files to Track as Downloads', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:97
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:99
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:103
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:106
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:108
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:110
	/* Translators: Add links to documentation. */
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:111
	__( 'Add domain', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:116
	/* Translators: Domain name example. */
	__( 'Domain (example: %s)', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEngagement.vue:119
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:48
	__( 'See Your Top Exit Pages to Reduce Abandonment', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:52
	__( 'See Your Top Outbound Links to Find New Revenue Opportunities', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:56
	__( 'See Your Top Affiliate Links and Focus on What’s Working', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:60
	__( 'See Your Top Downloads and Improve Conversions', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportPublishers-Lite.vue:64
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:296
	__( 'Top 10 Countries', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:297
	__( 'View Countries Report', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:298
	__( 'Top 10 Referrals', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:299
	__( 'View All Referral Sources', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:301
	__( 'View Full Posts/Pages Report', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:306
	__( 'Percentage of single-page visits (or web sessions). It is the number of visits in which a person leaves your website from the landing page without browsing any further.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:310
	__( 'This list shows the top countries your website visitors are from.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportOverview.vue:311
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportSearchConsole-Lite.vue:37
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportSearchConsole-Lite.vue:44
	__( 'See Your Top Google Search Terms and Optimize Content', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportSearchConsole-Lite.vue:48
	__( 'See The Number of Clicks and Track Interests', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportSearchConsole-Lite.vue:52
	__( 'See The Click-Through-Ratio and Improve SEO', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/reports/exactmetrics-ReportSearchConsole-Lite.vue:56
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportEcommerce-Lite.vue:37
	__( 'Increase your sales & revenue with insights. ExactMetrics answers all your top eCommerce questions using metrics like total revenue, conversion rate, average order value top products, top referral sources and more.', 'google-analytics-dashboard-for-wp' ),
	...
	// Reference: src/modules/reports/components/reports/exactmetrics-ReportEcommerce-Lite.vue:64
	__( 'See Your Top Conversion Sources and Focus on What\'s Working', 'google-analytics-dashboard-for-wp' ),
	...
	// Reference: src/modules/settings/components/input/tab-advanced/exactmetrics-SettingsInputPerformance-Lite.vue:19
	__( 'Performance', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-advanced/exactmetrics-SettingsInputPerformance-Lite.vue:20
 ...
 and other privacy regulations.', 'google-analytics-dashboard-for-wp' ),
	...
	// Reference: src/modules/reports/components/reports-overview/exactmetrics-ReportOverviewUpsell-Lite.vue:39
	__( 'Upgrade to', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/exactmetrics-ReportsPdfExport-Lite.vue:44
	__( 'Export PDF Report', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/reports/components/exactmetrics-ReportsPdfExport-Lite.vue:52
	...
	// Reference: src/modules/reports/components/exactmetrics-ReportsPagination.vue:35
	...
	// Reference: src/modules/settings/components/tabs/exactmetrics-SettingsTabEcommerce-Lite.vue:97
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:106
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:116
	__( 'Constant Contact', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:117
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:127
	__( 'SEMRUSH', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:128
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:141
	__( 'Engagement Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:145
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:158
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:168
	__( 'Smash Balloon - Facebook', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:179
	__( 'Smash Balloon - Instagram', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:180
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:190
	__( 'Popular Posts by ExactMetrics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:191
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:202
	__( 'Popular Products by ExactMetrics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:203
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:217
	__( 'Revenue Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:232
	__( 'SeedProd', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:233
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:23
	__( 'Featured Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:243
	__( 'Easy Affiliate', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:244
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:254
	__( 'SearchWP', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:255
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:265
	__( 'Easy Digital Downloads', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:266
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:276
	__( 'MemberPress', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:277
	__( 'Create a membership website. Works automatically with ExactMetrics, no coding needed.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:287
	__( 'Thirsty Affiliates', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:288
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:28
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:298
	__( 'Advanced Coupons', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:299
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:309
	__( 'PrettyLinks', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:310
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:313
	__( 'Install Now', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:323
	__( 'Online Marketing Guides & Resources', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:379
	__( 'Read This Guide', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:39
	__( 'ExactMetrics Pro', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:40
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:66
	__( 'Traffic Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:82
	__( 'All in One SEO (AIOSEO)', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:83
	__( 'The best WordPress SEO plugin that works automatically with ExactMetrics.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:94
	__( 'PushEngage', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:95
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:186
	__( 'Advanced Growth Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:187
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:198
	__( 'Track how your users interact with videos on your website.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:339
	__( 'Error Processing', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:340
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:47
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:82
	__( 'Standard Analytics & Reports', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:83
	__( 'Get the reports and stats that matter right inside your WordPress Dashboard.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:95
	__( 'Helps you see what links your users are clicking on your site.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:106
	__( 'All In One SEO Toolkit', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:107
	__( 'The best WordPress SEO plugin that works with ExactMetrics to boost your rankings.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:130
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:146
	__( 'ExactMetrics is connected to Google Analytics and data is being collected.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:150
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:154
	__( 'Success', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:155
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:164
	/* Translators: Add link to retrieve license from account area. */
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:170
	__( 'Verify License Key', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:172
	__( 'Upgrade to Unlock These Features', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:173
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:174
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:226
	__( 'Verifying License...', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepSuccess.vue:240
	__( 'There was an error unlocking ExactMetrics PRO please try again or install manually.', 'google-analytics-dashboard-for-wp' ),
	...
	// Reference: src/modules/addons/components/exactmetrics-AddonBlock.vue:66
	__( 'License Expired', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/exactmetrics-SettingsNetwork.vue:100
	...
	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:221
	__( 'WP Simple Pay', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/growth-tools/exactmetrics-growth-tools.vue:222
	...
	// Reference: src/modules/tools/components/exactmetrics-ToolsTabImportExport.vue:113
	/* Translators: Support link tag starts with url and support link tag ends. */
	...
	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:118
	__( 'Conversion Tools', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/wizard-onboarding/components/steps/exactmetrics-OnboardingStepRecommendedAddons-Lite.vue:119
