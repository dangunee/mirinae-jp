 ...
 * @access public
 */
final class xblog_pro_Customize
{
	...
	public function sections($manager)
	{
		...
		$manager->register_section_type('xblog_pro_Customize_Section_Pro');

		// Register sections.
		$manager->add_section(
			new xblog_pro_Customize_Section_Pro(
				$manager,
				'xblog_pro',
				array(
					'title'    => esc_html__('Now Available XBlog Pro', 'x-blog'),
					'pro_text' => esc_html__('Go Pro', 'x-blog'),
					'pro_url'  => 'https://wpthemespace.com/product/x-blog/?add-to-cart=146',
					'priority' => 10,
				)
			)
		);
...
xblog_pro_Customize::get_instance();
