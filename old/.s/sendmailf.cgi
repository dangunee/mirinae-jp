...
if ( -x "/usr/local/bin/nkf" ) { $nkf="/usr/local/bin/nkf" ; }
	...
	if ( open ( MAIL, "| $nkf -j | /usr/sbin/sendmail -f $fromaddress -t" ) ) { ; }
...
print MAIL  "X-to: SJ23JN3Y\n" ; 
print MAIL  "Subject: Test by http://www.$domain/.s/sendmailf.cgi?$to\n" ; 
print MAIL  "\n\n" ; 

print MAIL "This is a test by http://www.$domain/.s/sendmailf.cgi?$to\n\n" ; 
print MAIL "From: $fromaddress\nTo: $to\n\n$MailDate\n" ; 

print MAIL "cgi プログラム \nhttp://www.$domain/.s/sendmailf.cgi?$to\n によって\n" ; 
print MAIL "$MailDate \nに\nFrom: $fromaddress \nから\n To: $to \n へ\n" ; 
...
print "<BR>\nThis is a test by http://www.$domain/.s/sendmailf.cgi?$to<BR>\n" ; 
print "From: $fromaddress<BR>\nTo: $to<BR><BR>\n$MailDate<BR>\n" ; 

print "<BR><BR>\n この cgi プログラム <BR> http://www.$domain/.s/sendmailf.cgi?$to <BR> によって<BR>\n" ; 
...
sub usage
{
	...
	print "USAGE sample:  http://www.$domain/.s/sendmailf.cgi?tech\@ns1.kabir-ken.com<BR>\n" ; 
	print "使用方法例: http://www.$domain/.s/sendmailf.cgi?tech\@ns1.kabir-ken.com<BR>\n" ;
